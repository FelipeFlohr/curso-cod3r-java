...
public class ProdutoController {
	...
	@PostMapping
	public @ResponseBody Produto novoProduto(@RequestParam String nome) { // ResponseBody faz com que o método seja atrelado ao corpo da resposta. Não é necessário a implementação desse annotation
